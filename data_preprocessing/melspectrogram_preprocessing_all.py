...
def buildTrainset(source_ids, target_ids, cache_folder='./cache/'):
    data_dir = '/home/ubuntu/data/datasets'

    voc_manifest_path = os.path.join('./manifests', f'voc_manifest.csv')
    voc_df = pd.read_csv(voc_manifest_path, sep=',')
    source_ids = list(set(voc_df['speaker_id'].to_list()))

    coraal_manifest_path = os.path.join('./manifests', f'coraal_manifest.csv')
    coraal_df = pd.read_csv(coraal_manifest_path, sep=',')
    target_ids = list(set(coraal_df['speaker_id'].to_list()))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cache_folder', type=str, default='/home/ubuntu/data/datasets/melspec_dataset',
